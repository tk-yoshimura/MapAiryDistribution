...
namespace MapAiryPadeCoefGeneration {
    internal class CDFMinus {
        public static void Execute() {
            ...
            using (BinaryReader sr = new(File.OpenRead("../../../../results_disused/cdf_precision150.bin"))) {
            ...
            using (StreamWriter sw = new("../../../../results_disused/pade_cdfminus_precision151.csv")) {
