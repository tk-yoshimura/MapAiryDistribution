...
namespace MapAiryPadeCoefGeneration {
    internal class PDFMinus {
        public static void Execute() {
            ...
            using (BinaryReader sr = new(File.OpenRead("../../../../results_disused/pdf_precision150.bin"))) {
            ...
            using (StreamWriter sw = new("../../../../results_disused/pade_pdfminus_precision151.csv")) {
