...
namespace MapAiryPadeCoefGeneration {
    internal class CDFMinusLimit {
        public static void Execute() {
            ...
            using (BinaryReader sr = new(File.OpenRead("../../../../results_disused/cdf_limit_precision150.bin"))) {
            ...
            using (StreamWriter sw = new("../../../../results_disused/pade_cdfminuslimit_precision151.csv")) {
