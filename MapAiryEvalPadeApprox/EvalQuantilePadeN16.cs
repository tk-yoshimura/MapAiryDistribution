...
namespace MapAiryEvalPadeApprox {
    internal class EvalQuantilePadeN16 {
        static void Main() {
            MultiPrecision<Pow2.N16> max_err = "1e-145";

            using (StreamWriter sw = new("../../../../results_disused/quantile_upper_pade_eval.csv")) {
            ...
            using (StreamWriter sw = new("../../../../results_disused/quantile_lower_pade_eval.csv")) {
